    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val dateSetListener = object : DatePickerDialog.OnDateSetListener {
            override fun onDateSet(
                ...
                var data = formato.format(cal.time).toString()
...
*/
        ...
        bt_foto_periodo.setOnClickListener(object : View.OnClickListener{
            override fun onClick(p0: View?) {
                DatePickerDialog(this@MainActivity,dateSetListener,cal.get(Calendar.YEAR),
                cal.get(Calendar.MONTH),
                cal.get(Calendar.DAY_OF_MONTH)).show()
                //Toast.makeText(applicationContext,"$dia - $mes - $ano", Toast.LENGTH_SHORT).show()
