...
class FotoDia :AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        linearLayoutManager = LinearLayoutManager(this.applicationContext,LinearLayoutManager.VERTICAL,false)
    ...
    private fun configureRecyclerView(){
        rv_foto.layoutManager = LinearLayoutManager(this@FotoDia)
    }
